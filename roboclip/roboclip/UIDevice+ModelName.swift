...
extension UIDevice {
    /// Returns the device model identifier, e.g. "iPhone14,2".
    ...
    /// Human readable device model name like "iPhone 13 Pro".
    var modelName: String {
        var identifier = modelIdentifier
        // If running on a simulator, get the underlying device identifier
